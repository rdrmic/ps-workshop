<div id="item-detail" style="width: 850px;">
    <form method="post">
        <input type="hidden" name="id" id="incomplete-id" value="[@id]" />
        ...
        <ul class="form-style-1">
            ...
            <li>
                <label id="label-work_price">Cijena rada po poluproizvodu</label>
            ...
            <li>
                ...
                <div class="building-items-selections-list">[@biscuits_list]</div>
