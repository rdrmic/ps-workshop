<div id="item-detail" style="width: 850px;">
    <form method="post">
        ...
        <input type="hidden" id="selection-incompletes" value="[@incompletes]" />
        ...
        <ul class="form-style-1">
            ...
            <li>
                <label id="label-work_price"><span class="not-required">*</span>Cijena rada po gotovom proizvodu</label>
            ...
            <li>
                <label id="label-incompletes">Poluproizvodi</label>
                <div id="incompletes-selections" class="building-items-selections"><!-- JS-generated select elements --></div>
                <button type="button" class="button-orange" onclick="addBuildingItemSelection(this.form, 'incompletes');">+</button>
                
                <!-- read-only -->
                <div style="margin-top: 3px;">
                    <input type="text" name="incompletes_price" id="incompletes_price" value="[@incompletes_price]"
            ...
            <li>
                <!-- read-only -->
                <label class="readonly">Ukupna cijena gotovog proizvoda</label>
            ...
            <li class="button-bar">
                <button type="button" class="button-orange button-orange-calculate" onclick="calculateDefinition(this.form, 'products');">Izračunaj</button>
                
                <input type="submit" id="submit" name="submit" value="Spremi" disabled="disabled" class="disabled" />
                <button type="button" class="button-orange" onclick="document.location='?products';">Odustani</button>
            </li>
        </ul>
    </form>
</div>
