<div id="item-detail" style="width: 850px;">
    <form method="post">
        <input type="hidden" id="incomplete-id" value="[@id]" />
        <input type="hidden" id="selection-biscuits" value="[@biscuits]" />
        ...
        <ul class="form-style-1">
            ...
            <li>
                <label id="label-work_price"><span class="not-required">*</span>Cijena rada po poluproizvodu</label>
            ...
            <li>
                <label id="label-biscuits">Biskviti</label>
                <div id="biscuits-selections" class="building-items-selections"><!-- JS-generated select elements --></div>
                <button type="button" class="button-orange" onclick="addBuildingItemSelection(this.form, 'biscuits');">+</button>
                
                <!-- read-only -->
                <div style="margin-top: 3px;">
                    <input type="text" name="biscuits_price" id="biscuits_price" value="[@biscuits_price]"
            ...
            <li>
                <!-- read-only -->
                <label class="readonly">Ukupna cijena poluproizvoda</label>
            ...
            <li class="button-bar">
                <button type="button" class="button-orange button-orange-calculate" onclick="calculateDefinition(this.form, 'incompletes');">Izračunaj</button>
                
                <input type="submit" id="submit" name="submit" value="Spremi" disabled="disabled" class="disabled" />
                <button type="button" class="button-orange" onclick="document.location='?incompletes';">Odustani</button>
            </li>
        </ul>
    </form>
</div>
